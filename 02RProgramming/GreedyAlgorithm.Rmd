...
The Greedy Algorithm is an optimization algorithm, that picks up the objects with the greatest value until the constraint is reached. See e.g. <a href="https://ocw.mit.edu/courses/electrical-engineering-and-computer-science/6-0002-introduction-to-computational-thinking-and-data-science-fall-2016/lecture-slides-and-files/">Data Science MIT</a>
...
- Possible uses could be:
      ...
      - Choosing coins and bills to give the change back after paying cash
